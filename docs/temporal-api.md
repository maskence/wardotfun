...
`/api/map-change-images/v7/{area_id}.webp` and
...
a 768x432 WebP under `WARDOTFUN_CHANGE_THUMBNAIL_DIR`. Chrome captures only
after MapLibre reports the snapshot source, change source, and visible tiles
fully loaded. Cached previews are
