...
class MapChangeMaterialityStaticTests(unittest.TestCase):
    def test_material_component_thresholds_and_v6_assets_are_declared(self):
        ...
        self.assertIn("/api/map-change-images/v6/", repository)
        self.assertIn("/api/map-change-tiles/v5/", repository)
        self.assertIn("/api/map-change-images/v6/", routes)
